...
load(here("final/data/energy.rda"))
...
save(energy_train, file = "final/data/energy_train.rda")
save(energy_test,  file = "final/data/energy_test.rda")

#Folds 5 x 5
set.seed(100)
energy_folds <- vfold_cv(energy_train, v = 5, repeats = 4, strata = site_eui)

save(energy_folds,  file = "final/data/energy_folds.rda")
